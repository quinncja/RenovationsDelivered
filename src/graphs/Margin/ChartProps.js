...
export const marginChartProps = {
    layers: ["grid", "axes", ZeroLineLayer, AreaLayer, LineLayer, "crosshair", "slices"],
    defs: [
    ...
    enableArea: true,
    singleItem: (singleItemData, open, showLabel) => <SingleMargin data={singleItemData} open={open} showLabel={showLabel}/>,
}