...
export const DashboardProvider = ({ children }) => {
    ...
    const loadJobData = async () => {
      ...
      const attemptLoad = async () => {
        try {
          ...
          const homeData = await fetchDashboardData(controller.signal);
          setDataMap((prev) => {
    ...
    const loadOpenData = async () => {
      ...
      const attemptLoad = async () => {
        ...
        try {
          ...
          const items = await fetchDashboardOpenData(mods, controller.signal);
  ...
  const getOpenMonthFinances = () => {
    return getWidgetDataById("openMonthFinances")
  }
