...
import { useSystemMessage } from "@shared/context/SystemMessageContext";
import { useRedo, useUndo } from "@shared/hooks/useHistory";
...
export const HistoryProvider = ({ children }) => {
  ...
  return (
    <HistoryContext.Provider
      value={{ pushHistory, handleRedo, handleUndo, undoActive, redoActive }}
    >
      {children}
    </HistoryContext.Provider>
  );
