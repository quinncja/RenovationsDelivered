...
function Margin() {
  ...
  const yearSum = homeRevData && homeRevData.find((item) => item.year === year)?.revenue;
  ...
  const margin = () => {
    return(
        ...
        >
          <h4 style={{color: "white", opacity: ".9"}}> Completed Job Margin </h4>
  ...
  return (
    ...
    <div style={{display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: "10px", position: "relative", boxSizing: "border-box"}}> 
    <div className="widget" style={{height: "280px", boxSizing: "border-box", justifyContent: 'center'}}> 
      <h4 style={{textAlign: "left", color: "white", fontSize: "16px"}}> Contract Completion Progress </h4>
      <CompletionPie totalContracted={yearSum} completedContracted={total.TotalContract}/>
    </div>
