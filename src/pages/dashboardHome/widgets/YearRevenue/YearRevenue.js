...
function YearRevenue() {
  ...
  return (
    <div className="home-yearrevenue-widget">
        <div style={{display: "flex", justifyContent: "space-between", padding: "25px", paddingBottom: "0px", alignItems: "flex-start"}}>
            <h2>
                Cumulative Revenue Growth
            </h2>
            <div style={{display: "flex", flexDirection: "row", gap: "20px"}}>
            <div style={{display: "flex", flexDirection: "row", gap: "10px", alignItems: "center"}}> 
                <div style={{width: "15px", height: "15px", borderRadius: "15px", background: "var(--green)"}}/>
                    <div style={{ display: "flex", flexDirection: "column", textAlign: "left" }}>
                    <h4 style={{color: "#ffffff"}}> {year} </h4>
                </div>
            </div>
            <div style={{display: "flex", flexDirection: "row", gap: "10px", alignItems: "center"}}> 
                <div style={{width: "15px", height: "15px", borderRadius: "15px", background: "var(--closed)"}}/>
                    <div style={{ display: "flex", flexDirection: "column", textAlign: "left" }}>
