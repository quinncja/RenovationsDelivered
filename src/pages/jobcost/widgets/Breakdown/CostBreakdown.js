...
export default function CostBreakdown({ budget, costItems, open = false, color, type }) {
  ...
  return (
    <>
      <div style={{ display: "flex", flexDirection: "column", gap: "10px", paddingInline: "25px", paddingTop: "15px", paddingBottom: "10px"}}>
        <div style={{ 
          display: "flex", 
          flexDirection: "row", 
          width: "100%", 
          ...
          <div style={{ 
            ...
            <h4>
              of {dollarFormatter(budget || 0)}  {utilizationRate != null && isFinite(utilizationRate) ? ` • ${utilizationRate.toFixed(0)}% utilized` : ""}
            </h4>
          </div>
          <div style={{ 
            display: "flex", 
            ...
            <>
              {postedSum > 0 && (
                <div
                  style={{
                    height: "8px",
                    borderRadius: actualCommittedAmount > 0 ? "15px 0px 0px 15px" : "15px",
