...
function JobDetails(){
    ...
    if (!data) {
        return ( 
            <div style={{display: "flex", flexDirection: "row", width: "100%", gap: "7px", boxSizing: "border-box"}}> 
            <div className="jobcost-details-widget loading-widget"/> 
            <div style={{display: "flex", flexDirection: "column", gap: "7px", width: "100%"}}> 
            <div style={{display: "flex", flexDirection: "row", gap: "7px", flexGrow: '1', height: '100%', boxSizing: "border-box"}}> 
                <SubcontractButton/>
                </div>
                <ChangeOrderButton/>
                </div>
    ...
    const infoBoxes = (details) => {
        const margin = (details.ContractAmount - jobDetails.cost) / details.ContractAmount * 100
        const marginClass = getMarginClass(margin);
        const markup = ((details.ContractAmount - jobDetails.budget) / jobDetails.budget) * 100 
        ...
        return(
            <div style={{display: "flex", flexDirection: "row", width: "80%", flexGrow: "1", alignItems: "center", paddingInline: "25px", paddingBlock: "25px", height: "150px", boxSizing: "border-box", justifyContent: "flex-start", gap: "0px", overflowX: "scroll"}}>

            <div className="jobcost-detail-box" style={{display: 'flex', flexDirection: "column", textAlign: 'left', flexShrink: 0}}>
                <h4>
                    Current Margin
                </h4>
            ...
            <div className="jobcost-detail-box" style={{display: 'flex', flexDirection: "column", textAlign: 'left'}}>
                ...
                <div className="jobcost-hl"/>
                <h5>
                    {dollarFormatter(remaining)} {remaining >= 0 ? "remaining" : "over budget"}
                </h5>
                </div>
            </div>
            <div className="jobcost-detail-box" style={{display: 'flex', flexDirection: "column", textAlign: 'left'}}>
    ...
    return(
        <div style={{display: "flex", flexDirection: "row", width: "100%", gap: "7px", boxSizing: "border-box"}}> 
        <div className="jobcost-details-widget">
            {infoBoxes(data[0])}
        </div>
        <div style={{display: "flex", flexDirection: "column", gap: "7px", width: "100%"}}> 
            <div style={{display: "flex", flexDirection: "row", gap: "7px", flexGrow: '1', height: '100%', boxSizing: "border-box"}}> 
