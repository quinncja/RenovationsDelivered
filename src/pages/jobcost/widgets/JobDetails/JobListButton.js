import { buildingSvg, downArrowSvg, rightArrowSvg } from "business/svg";
...
function JobListButton({isOpen, setIsOpen}){
    ...
    return(
        ...
        >
          <h2 style={{ fontWeight: 700, fontSize: '20px'}}> {totalProjects || 0}</h2>
        ...
        <>
          ...
          >
            ...
            <h5 style={{ opacity: 0, minWidth: "17ch", fontSize: '20px'}}> Projects </h5>
          </div>
        </>
      )}
        </div>
