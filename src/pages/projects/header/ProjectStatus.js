...
function ProjectStatus() {
  ...
  return (
    ...
    style={{ flexShrink: "0", display: "flex", flexDirection: "row",
      ...
      <div style={{display: "flex", flexDirection: "column", paddingBottom: "5px", gap: "5px", marginInline: "22px", minWidth: "9ch", alignContent: "center", alignItems: "flex-start", justifyContent: "center"}}>
