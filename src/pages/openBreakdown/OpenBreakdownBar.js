...
import { venderMap } from "pages/dashboardHome/widgets/Insights/Label";

function OpenBreakdownBar(props) {
  const { data } = props;
  ...
  if (posted.length === 0 && committed.length === 0) return( 
...
export default OpenBreakdownBar;