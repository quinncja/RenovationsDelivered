...
function Filters() {
  const { breakdownData, updateFocusedId, typeFilter, setTypeFilter } = useJobCostContext();
  ...
  return (
    ...
    > {focused &&
      ...
      >
        <span className="phase-dot-small under-dot " style={{background: getColor(focused, "Tranquil")}}></span> 
        <h4>{focused}</h4>
      </div>
       }
      <div
